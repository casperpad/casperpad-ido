...
const addOrders = async () => {
  ...
  const account = "account-hash-f2af240a5aa234d6e295ff65b011126dc002f655b1034f869f38b7b2ba60e450";
  const amount = parseFixed("100", 9);
  orders.set(account, amount);
  const deployHash = await idoContract.addOrders(KEYS, orders, DEFAULT_RUN_ENTRYPOINT_PAYMENT);
