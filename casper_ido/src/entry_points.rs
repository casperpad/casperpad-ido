...
use crate::constants::{
    ...
    PROJECT_ID_RUNTIME_ARG_NAME, PROJECT_NAME_RUNTIME_ARG_NAME, PROJECT_OPEN_TIME_RUNTIME_ARG_NAME,
    ...
    PROJECT_TOKEN_CAPACITY_RUNTIME_ARG_NAME, PROJECT_TOKEN_PRICE_USD_RUNTIME_ARG_NAME,
    PROOF_RUNTIME_ARG_NAME, SCHEDULE_ID_RUNTIME_ARG_NAME, SET_CSPR_PRICE_ENTRY_NAME,
    SET_MERKLE_ROOT_ENTRY_NAME, SET_MULTIPLE_TIERS_ENTRY_NAME, SET_PROJECT_STATUS_ENTRY_NAME,
    SET_PURSE_ENTRY_NAME, SET_TIER_ENTRY_NAME, TIER_RUNTIME_ARG_NAME,
    TRANSFER_OWNERSHIP_ENRTY_NAME, TREASURY_WALLET_RUNTIME_ARG_NAME,
};
...
pub fn add_project() -> EntryPoint {
    EntryPoint::new(
        ...
        vec![
            ...
            Parameter::new(PROJECT_TOKEN_CAPACITY_RUNTIME_ARG_NAME, CLType::U256),
...
pub fn default() -> EntryPoints {
    ...
    entry_points.add_entry_point(set_multiple_tiers());
    entry_points.add_entry_point(set_tier());
