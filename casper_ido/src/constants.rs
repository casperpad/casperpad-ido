...
pub const PROJECT_TOKEN_DECIMALS_RUNTIME_ARG_NAME: &str = "token_decimals";
...
pub const PROJECT_TOTAL_INVESTS_AMOUNT_RUNTIME_ARG_NAME: &str = "total_invests_amount";
pub const PROJECT_TOKEN_CAPACITY_RUNTIME_ARG_NAME: &str = "token_capacity";
